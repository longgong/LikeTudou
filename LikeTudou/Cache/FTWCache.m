...
+ (NSData*) objectForKey:(NSString*)key {
	...
	{
		NSDate *modificationDate = [[fileManager attributesOfItemAtPath:filename error:nil] objectForKey:NSFileModificationDate]; //文件修改日期
...
+ (void) setObject:(NSData*)data forKey:(NSString*)key {
	...
	if (![fileManager fileExistsAtPath:self.cacheDirectory isDirectory:&isDir]) {
		[fileManager createDirectoryAtPath:self.cacheDirectory withIntermediateDirectories:NO attributes:nil error:nil]; //创建文件夹
	}
